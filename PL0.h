...
char *word[NRW + 1] =
        {
                ...
                "odd", "procedure", "step", "then", "until", "var", "while"
        };

int wsym[NRW + 1] =
        {
                SYM_NULL, SYM_BEGIN, SYM_CALL, SYM_CONST, SYM_DO, SYM_ELSE, SYM_END, SYM_FOR,
                SYM_IF, SYM_ODD, SYM_PROCEDURE, SYM_STEP, SYM_THEN, SYM_UNTIL, SYM_VAR, SYM_WHILE
        };
